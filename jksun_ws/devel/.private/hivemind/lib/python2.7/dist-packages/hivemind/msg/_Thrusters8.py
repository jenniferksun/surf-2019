...
"""autogenerated by genpy from hivemind/Thrusters8.msg. Do not edit."""
import sys
...
class Thrusters8(genpy.Message):
  ...
  _type = "hivemind/Thrusters8"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """#Thruster values for the 3DOF (8 thruster) Spacecraft simulator
