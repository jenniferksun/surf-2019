...
(cl:defmethod cl:initialize-instance :after ((m <Thrusters8>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Thrusters8)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name blackroom-msg:<Thrusters8> is deprecated: use blackroom-msg:Thrusters8 instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blackroom-msg:header-val is deprecated.  Use blackroom-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'FXpMZp-val :lambda-list '(m))
(cl:defmethod FXpMZp-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blackroom-msg:FXpMZp-val is deprecated.  Use blackroom-msg:FXpMZp instead.")
  (FXpMZp m))

(cl:ensure-generic-function 'FXpMZm-val :lambda-list '(m))
(cl:defmethod FXpMZm-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blackroom-msg:FXpMZm-val is deprecated.  Use blackroom-msg:FXpMZm instead.")
  (FXpMZm m))

(cl:ensure-generic-function 'FXmMZp-val :lambda-list '(m))
(cl:defmethod FXmMZp-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blackroom-msg:FXmMZp-val is deprecated.  Use blackroom-msg:FXmMZp instead.")
  (FXmMZp m))

(cl:ensure-generic-function 'FXmMZm-val :lambda-list '(m))
(cl:defmethod FXmMZm-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blackroom-msg:FXmMZm-val is deprecated.  Use blackroom-msg:FXmMZm instead.")
  (FXmMZm m))

(cl:ensure-generic-function 'FYpMZp-val :lambda-list '(m))
(cl:defmethod FYpMZp-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blackroom-msg:FYpMZp-val is deprecated.  Use blackroom-msg:FYpMZp instead.")
  (FYpMZp m))

(cl:ensure-generic-function 'FYpMZm-val :lambda-list '(m))
(cl:defmethod FYpMZm-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blackroom-msg:FYpMZm-val is deprecated.  Use blackroom-msg:FYpMZm instead.")
  (FYpMZm m))

(cl:ensure-generic-function 'FYmMZp-val :lambda-list '(m))
(cl:defmethod FYmMZp-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blackroom-msg:FYmMZp-val is deprecated.  Use blackroom-msg:FYmMZp instead.")
  (FYmMZp m))

(cl:ensure-generic-function 'FYmMZm-val :lambda-list '(m))
(cl:defmethod FYmMZm-val ((m <Thrusters8>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader blackroom-msg:FYmMZm-val is deprecated.  Use blackroom-msg:FYmMZm instead.")
  (FYmMZm m))
